...
WITH seeded AS (
  ...
  VALUES
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     1800.00, NULL, NULL, NULL, NULL, NULL, 'REVIEW'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     4200.00, NULL, NULL, NULL, NULL, NULL, 'REVIEW'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     NULL, NULL, 9500.00, NULL, NULL, NULL, NULL, NULL, 'DECISION'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     CURRENT_TIMESTAMP - INTERVAL '1 day', NULL, 'DECISION'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     CURRENT_TIMESTAMP - INTERVAL '2 days', NULL, 'REVIEW'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     240000.00, NULL, NULL, NULL, NULL, 340000.00, 'REVIEW'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     120000.00, NULL, NULL, NULL, NULL, 150000.00, 'VERIFICATION'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     CURRENT_TIMESTAMP - INTERVAL '1 day',
     850000.00, NULL, NULL, NULL, NULL, 950000.00, 'DECISION'),
    ...
    ('CLM-' || lpad(nextval('claim_number_seq')::text, 6, '0'),
     ...
     CURRENT_TIMESTAMP - INTERVAL '3 days', 1400000.00, 'DECISION')
