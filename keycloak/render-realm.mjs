...
// __ADJUSTER_PASSWORD__ / __SUPERVISOR_PASSWORD__ / __CLAIMANT_PASSWORD__ placeholders
...
for (const name of ['ADJUSTER_PASSWORD', 'SUPERVISOR_PASSWORD', 'CLAIMANT_PASSWORD']) {
  if (!process.env[name]) {
...
const rendered = template
  ...
  .replaceAll('__CLAIMANT_PASSWORD__', process.env.CLAIMANT_PASSWORD);
